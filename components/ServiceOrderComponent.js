  ...
  return (
    <div className="orcamento-container">
      ...
      <div className="flex gap-2">
        ...
        <div className="page-break-avoid col-span-2 w-2/3">
              ...
              <div className="">
                <div className="flex items-center gap-2 ">
                  ...
                  <div>
                    ...
                    <p className="font-bold">{title || "Não informado"}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-bold">{traduzirStatus(status)}</p>
                  </div>
                </div>
              </div>
              <div className="">
        ...
        {/* Dados do cliente */}
        <div className="page-break-avoid text-sm w-1/3 bg-gray-100 p-3 rounded-md">
          <h3 className="text-lg font-semibold text-gray-900 ">
            Dados do Cliente
          </h3>
          <div className="mt-1">
            ...
            <div className="text-xs">
              ...
              <div className="mb-1 flex items-center gap-2">
                ...
                <span>{formatarTelefone(customerPhone)}</span>
              </div>
              <div className="mb-1 flex items-center gap-2">
                <FileText className="text-muted-foreground h-4 w-4" />
                <span>{formatarDocumento(customerDocument, customerType)}</span>
              </div>
            </div>
            {customerAddress && (
              <p className="border-t pt-3 mt-3 text-muted-foreground text-xs leading-relaxed uppercase">
                {customerAddress.street}, {customerAddress.number || "S/N"}
                {customerAddress.complement &&
                  `, ${customerAddress.complement}`}
                <br />
                {customerAddress.neighborhood} - {customerAddress.city}/
                {customerAddress.state} -{" "}
                {customerAddress.zipcode || "Não informado"}
              </p>
            )}
          </div>
        </div>
      ...
      {/* {(start_date || end_date || estimated_completion) && (
        <div className="page-break-avoid">
          ...
          <div className="grid grid-cols-3 gap-6 bg-blue-50 p-4 rounded-lg">
            {start_date && (
              <div>
                <p className="font-bold text-blue-900">Data de Início</p>
            ...
            <tbody>
              {items && items.length > 0 ? (
                items.map((item, index) => (
                  ...
                  >
                    <td className="p-1.5 font-medium text-center">
                      {index + 1}
                    </td>
